...
@section('title', 'Struk Pembayaran Klinik')

@section('content')
<div class="container-fluid">
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden print-area">
        <div class="bg-gray-50 p-6 text-center border-b-4 border-pink-600">
            <div class="w-16 h-16 bg-pink-600 rounded-full flex items-center justify-center mx-auto mb-3 text-white">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-2xl font-bold">
                        ...
                        INVOICE KLINIK #{{ $tagihan->tagihan_id }}
                    </h3>
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 gap-6 mb-6">
                <div>
                    <h6 class="font-bold text-pink-600 mb-3 flex items-center">
            ...
            <h6 class="font-bold text-pink-600 mb-3 border-t pt-4 flex items-center">
            ...
            <div class="overflow-x-auto border rounded-lg shadow-sm">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-pink-600 text-white">
                        <tr>
                            <th class="px-4 py-3 text-left text-sm font-semibold">Deskripsi Layanan</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right font-bold text-sm text-pink-600">Rp {{ number_format($detail->subtotal, 0, ',', '.') }}</td>
                        </tr>
                        @endforeach
                        <tr class="bg-gray-50">
                            <th colspan="3" class="px-4 py-3 text-right text-base font-bold text-gray-900">TOTAL TAGIHAN</th>
                            <th class="px-4 py-3 text-right text-lg font-extrabold text-pink-600">
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg border-l-4 border-pink-500">
            ...
            <div class="mt-6 text-center p-6 bg-pink-50 rounded-lg">
                <h5 class="font-bold text-lg text-pink-600 mb-3 flex items-center justify-center">
        ...
        <div class="p-6 border-t border-gray-200 flex justify-center space-x-4 no-print">
            ...
            <a href="{{ route('kasir-klinik.dashboard') }}" class="px-6 py-3 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 transition-colors">
...
@media print {
    ...
    .bg-pink-600, .bg-pink-700, .bg-gray-50, .bg-green-500 {
