...
@section('title', 'Proses Pembayaran - Kasir Klinik')

@section('content')
<div class="max-w-6xl mx-auto space-y-6">
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-gradient-to-r from-pink-600 to-pink-700 text-white p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="opacity-90 text-sm mt-1">Tagihan #{{ $tagihan->tagihan_id }}</p>
                </div>
                <div>
                    <a href="{{ route('kasir-klinik.dashboard') }}" class="px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-md transition-colors text-sm font-medium">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-lg shadow-md p-6 h-full">
            <h5 class="text-lg font-semibold text-gray-800 mb-4 border-b pb-2 flex items-center">
                <svg class="w-5 h-5 mr-2 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Detail Tagihan Klinik
            </h5>
            
            <div class="bg-gray-50 rounded-lg p-4 mb-4 border-l-4 border-pink-500">
                ...
                <div class="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div class="col-span-2">
                        ...
                        <span class="px-2 py-0.5 inline-flex text-xs font-semibold rounded-full {{ $tagihan->jenis_tagihan == 'konsultasi' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800' }}">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-3 hover:shadow-sm transition-shadow">
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <div class="text-right ml-4">
                                ...
                                <strong class="text-pink-600">Rp {{ number_format($detail->subtotal, 0, ',', '.') }}</strong>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="mt-6 p-4 rounded-lg text-center bg-gradient-to-r from-pink-500 to-pink-600 text-white shadow-lg">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('kasir-klinik.processPayment', $tagihan->tagihan_id) }}" method="POST" id="paymentForm">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" 
                               ...
                               name="jumlah_bayar" 
                               id="jumlah_bayar" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg pl-10 focus:ring-2 focus:ring-pink-500 focus:border-pink-500" 
                               required 
                    ...
                    <small class="text-gray-500 mt-1 block">
                        <svg class="w-3 h-3 inline mr-1 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-semibold text-gray-700 mb-3 flex items-center">
                        <svg class="w-4 h-4 mr-2 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <div class="relative">
                            ...
                            <label for="{{ strtolower($method) }}" class="block p-4 text-center border-2 border-gray-300 rounded-lg cursor-pointer transition-all duration-200 peer-checked:border-pink-500 peer-checked:bg-pink-500 peer-checked:text-white hover:bg-gray-50">
                                @if($method === 'Tunai')
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                    <h6 class="font-semibold text-gray-800 mb-3 flex items-center">
                        <svg class="w-4 h-4 mr-2 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v4m0 0h-6m6 0H9m10 0V9a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2h6m4-10a2 2 0 012 2v4m-2-6V9a2 2 0 00-2-2h-4a2 2 0 00-2 2v4"/></svg>
                ...
                <button type="submit" class="w-full bg-pink-600 text-white font-semibold py-3 rounded-lg hover:bg-pink-700 transition-colors shadow-md disabled:bg-gray-400" id="submitBtn" disabled>
                    ...
                    <span>Proses Pembayaran Lunas</span>
                </button>
                
                <a href="{{ route('kasir-klinik.dashboard') }}" class="mt-3 block w-full text-center px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
            </form>
        </div>
