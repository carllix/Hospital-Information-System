...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-xl font-bold text-gray-800 mb-2">Jadwal Kunjungan Mendatang</h2>
        <p class="text-sm text-gray-600">Daftar janji temu/kunjungan Anda yang akan datang. Pastikan Anda hadir tepat waktu sesuai jadwal.</p>
    </div>
