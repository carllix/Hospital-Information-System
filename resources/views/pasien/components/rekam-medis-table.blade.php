        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{ $item->tanggal_pemeriksaan->translatedFormat('j F Y') }}</div>
                    <div class="text-xs text-gray-500">{{ $item->tanggal_pemeriksaan->format('H:i') }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
