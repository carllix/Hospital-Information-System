...
@section('dashboard-title', 'Riwayat Transaksi Apotek')
...
<div class="space-y-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-teal-50 p-4 rounded-lg text-center border-l-4 border-teal-500">
                <p class="text-sm text-gray-600">Total Penjualan Obat</p>
                <p class="text-xl font-bold text-teal-600 mt-1">Rp {{ number_format($summary['total_revenue'], 0, ',', '.') }}</p>
            </div>
            ...
            <div class="bg-gray-50 p-4 rounded-lg text-center border-l-4 border-gray-500">
                <p class="text-sm text-gray-600">Transaksi Obat</p>
                <p class="text-xl font-bold text-gray-600 mt-1">{{ number_format($summary['obat_count']) }}</p>
            </div>
            <div class="bg-blue-50 p-4 rounded-lg text-center border-l-4 border-blue-500">
                ...
                <p class="text-xl font-bold text-blue-600 mt-1">Rp {{ number_format($summary['total_revenue'] / max(1, $summary['transaction_count']), 0, ',', '.') }}</p>
            </div>
        </div>
        
        <form method="GET" action="{{ route('kasir-apotek.riwayat') }}" class="flex flex-wrap items-end gap-4">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Daftar Penjualan Obat Lunas</h3>
        </div>
        ...
        @if($riwayat->count() > 0)
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr class="bg-gray-50">
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">ID Resep</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900">
                                ...
                                <div class="text-xs text-gray-500">RM: {{ $tagihan->pasien->no_rm ?? '-' }}</div>
                            </td>
        ...
        @else
            <div class="px-6 py-12 text-center text-gray-500">
                ...
                <p class="text-lg font-medium">Tidak ada riwayat penjualan obat</p>
