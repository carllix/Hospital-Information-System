...
@section('title', 'Kasir Lab | Ganesha Hospital')
@section('dashboard-title', 'Dashboard Kasir Laboratorium')
...
<div class="space-y-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Dashboard Kasir Laboratorium</h2>
                <p class="text-gray-600">Kelola pembayaran pemeriksaan laboratorium dengan efisien</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="GET" action="{{ route('kasir-lab.dashboard') }}" class="flex flex-wrap items-end gap-4">
            <div class="flex-1 min-w-48">
                <label for="start_date" class="block text-sm font-medium text-gray-700 mb-2">
                    <svg class="w-4 h-4 inline mr-1 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    Tanggal Mulai
                </label>
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('kasir-lab.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md transition-colors font-medium">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-gray-500 text-sm">Total Pendapatan Lab</p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-gray-500 text-sm">Pemeriksaan Selesai</p>
        ...
        <div class="lg:col-span-2 bg-white rounded-lg shadow-md">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-800 flex items-center">
                    ...
                    Pemeriksaan Lab Menunggu Pembayaran
                </h3>
            </div>
            <div class="p-6">
                @if($tagihanPending->count() > 0)
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="bg-gray-50">
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">ID Lab</th>
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">Pasien</th>
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">Jenis Test</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-t border-gray-200 hover:bg-gray-50">
                                    <td class="px-4 py-3 font-medium text-purple-600">#{{ $tagihan->tagihan_id }}</td>
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="{{ route('kasir-lab.show', $tagihan->tagihan_id) }}" 
                                           class="bg-purple-600 hover:bg-purple-700 text-white px-3 py-1 rounded-md text-sm transition-colors font-medium">
                ...
                @else
                    <div class="text-center py-8 text-gray-500">
                        ...
                        <p>Tidak ada pemeriksaan lab yang menunggu pembayaran</p>
                    </div>
                @endif
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                @if($recentTransactions->count() > 0)
                    <div class="mt-4 text-center">
                        <a href="{{ route('kasir-lab.riwayat') }}" class="text-purple-600 hover:text-purple-700 text-sm font-medium">
                            Lihat Semua Riwayat →
                        </a>
                    </div>
                @endif
