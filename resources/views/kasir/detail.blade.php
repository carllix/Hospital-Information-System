    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <table class="w-full">
                        ...
                        <tfoot class="bg-gray-50 text-sm">
                            <tr>
                                ...
                                <td class="text-pink-600 px-6 py-4 text-right font-bold text-gray-900">Rp {{ number_format($tagihan->total_tagihan, 0, ',', '.') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <a href="{{ route('kasir.invoice', $tagihan->tagihan_id) }}" class="mt-4 block w-full px-4 py-3 bg-[#f56e9d] text-white text-center font-semibold rounded-lg hover:bg-[#d14a7a] transition-colors">
                    Lihat Invoice
                </a>
                @else
                <div class="p-4 bg-amber-50 rounded-lg text-center mb-4">
                ...
                <form action="{{ route('kasir.proses-pembayaran', $tagihan->tagihan_id) }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($tagihan->total_tagihan, 0, ',', '.') }}</p>
                        </div>
                        ...
                        <button type="submit" class="w-full px-4 py-3 bg-[#f56e9d] text-white font-semibold rounded-lg hover:bg-[#d14a7a] transition-colors">
                            Proses Pembayaran
                        </button>
                    </div>
                </form>
