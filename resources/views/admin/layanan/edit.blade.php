...
@section('title', 'Edit Layanan | Admin Ganesha Hospital')
...
<div class="mx-auto">
    <div class="mb-6">
        <a href="{{ route('admin.layanan.show', $layanan->layanan_id) }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-800 transition-colors">
