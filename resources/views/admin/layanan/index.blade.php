...
@section('title', 'Data Layanan | Admin Ganesha Hospital')
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button
                                        type="button"
                                        onclick="showDeleteModal({{ $layanan->layanan_id }}, '{{ $layanan->nama_layanan }}', 'layanan')"
                                    ...
                                    <form id="deleteForm-{{ $layanan->layanan_id }}" action="{{ route('admin.layanan.destroy', $layanan->layanan_id) }}" method="POST" class="hidden">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
